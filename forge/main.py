"""Forge entry point — CLI argument parsing and app bootstrap.

Usage:
    forge                              # Interactive mode
    forge "fix the bug in main.py"     # One-shot mode
    forge --provider minimax --model MiniMax-M2.5 "task"
"""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="forge",
        description="Forge — a lightweight, extensible coding agent",
    )
    parser.add_argument(
        "task",
        nargs="?",
...
def main() -> None:
    ...
    from forge.cli.app import ForgeApp
