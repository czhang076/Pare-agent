...
Two modes:
1. One-shot: `forge "fix the bug in main.py"` — run task, exit.
2. Interactive: `forge` — REPL loop, multi-turn conversation.
...
class ForgeApp:
    """The main Forge CLI application.

    Usage:
        app = ForgeApp(provider="minimax", model="MiniMax-M2.5")
